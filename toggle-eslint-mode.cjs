 ...
 * 
 * Usage:
 *   node toggle-eslint-mode.cjs soft   # Enable soft mode
 *   node toggle-eslint-mode.cjs strict # Enable strict mode
 */
...
function enableSoftMode() {
  ...
  console.log('   To restore strict mode, run: node toggle-eslint-mode.cjs strict');
}
...
if (mode === 'soft') {
  ...
  console.log('   Usage: node toggle-eslint-mode.cjs [soft|strict]');
}